...
# NOTE: This is a highly inefficient implementation of this
#       algorithm. However, I have chosen to use this
#       implementation because it most closely matches the
#       algorithm given in Definition 3.1.
#
#       A much more efficient implementation can be obtained
#       by using slightly more advanced data structures to
#       represent both the graph and the edges. For more
#       information see [1, pp. 634 -- 636].
